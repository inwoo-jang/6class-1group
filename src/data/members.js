 ...
 * previewPath      위치 권한이 없을 때 표지 카드에 대신 띄울 화면 (선택).
 *                  '/m/<slug>' 뒤에 붙는다. 첫 화면이 위치를 기다리는 사람만
 *                  적으면 된다 — 카드는 축소된 그림이라 그 안에서 "허용"을
 *                  눌러 줄 사람이 없다. 권한이 이미 있으면 첫 화면을 그대로 띄운다.
 *
...
export const MEMBERS = [
  ...
  },
  {
    ...
    // 첫 화면이 위치 권한을 기다린다 — 권한이 없을 때만 서울로 대신 띄운다
